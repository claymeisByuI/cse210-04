...
class VideoService:
    ...
    def __init__(self, caption, width, height, cell_size, cell_rows, cell_cols, frame_rate, debug = False):
    ...
    def get_cell_rows(self):
        """Gets the video screen's cell rows.
        
        Returns:
            Grid: The video screen's cell rows.
        """
        return self._cell_rows
    def get_cell_cols(self):
        """Gets the video screen's cell cols.
        
        Returns:
            Grid: The video screen's cell cols.
        """
